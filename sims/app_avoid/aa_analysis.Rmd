...
This file takes the output from these five approach-avoid analysis scripts - E1_aa_run.R; E2_aa_noisy_intent.R; E2_aa_noisy_stim; E3_imitate_run_animacy; E3_imitate_run_noisy_faces (or the aa_sim.Rmd file, which does the same thing), wrangles the data, produces various plots and runs some statistical analyses. 
